...
\anotecontent{long-short}{Going long refers to buying an asset with the expectation that its value will increase, allowing it to be sold for a profit later. Conversely, going short refers to profiting from a decline in the asset's value~\cite{Investo_LongShort}.}
